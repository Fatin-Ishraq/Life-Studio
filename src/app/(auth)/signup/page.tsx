...
export default function SignUpPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden bg-gradient-to-br from-neutral-50 via-white to-neutral-50">
            ...
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-primary-500/10 to-violet-500/10 blur-[120px] rounded-full translate-x-1/2 -translate-y-1/2" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-br from-cyan-500/10 to-blue-500/10 blur-[120px] rounded-full -translate-x-1/2 translate-y-1/2" />
                ...
                <div className="bg-white/80 backdrop-blur-2xl rounded-[32px] shadow-2xl shadow-neutral-200/50 border border-white/50 p-8">
                    ...
                    <form onSubmit={handleEmailSignUp} className="space-y-5">
                        <div className="space-y-2">
                            <label htmlFor="name" className="text-[10px] font-black uppercase text-neutral-400 tracking-widest block pl-1">
                                Full Name
                            </label>
                            <div className="relative group">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-neutral-400 group-focus-within:text-neutral-900 transition-colors" />
                                <input
                                    id="name"
                                    type="text"
                                    value={displayName}
                    ...
                    <p className="mt-8 text-center text-sm font-medium text-neutral-500">
                        ...
                        <Link href="/login" className="font-bold text-neutral-900 hover:text-primary-600 transition-colors">
                            Sign in →
                        </Link>
                    </p>
                </div>
