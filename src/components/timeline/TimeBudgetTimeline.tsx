...
export function TimeBudgetTimeline() {
    ...
    if (loading) return (
        <div className="card p-6 animate-pulse">
            <div className="h-20 bg-neutral-100 rounded-xl mb-6" />
            <div className="h-16 bg-neutral-100 rounded-xl" />
        </div>
    );

    return (
        <div className="card p-6 backdrop-blur-sm bg-white/40 border border-white/20">
            {/* Header */}
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-neutral-900 to-neutral-600">
                        Today&apos;s Rhythm
                    </h3>
                    <p className="text-sm text-neutral-500 mt-1">
                        <span className="font-semibold text-neutral-900">{Math.floor(allocatedMins / 60)}h {allocatedMins % 60}m</span> planned
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className="p-2.5 rounded-xl bg-neutral-100/50 text-neutral-500 hover:text-neutral-900 hover:bg-neutral-100 transition-all duration-200"
                        title="Day Settings"
                    >
                    ...
                    <button
                        ...
                        className="px-4 py-2.5 rounded-xl bg-neutral-900 text-white font-medium hover:bg-neutral-800 active:scale-95 transition-all duration-200 flex items-center gap-2 shadow-lg shadow-neutral-200"
                    >
            ...
            <div className="relative pt-6 pb-2">
                ...
                <div className="absolute top-0 left-0 w-full flex pointer-events-none h-full">
                    {hourMarkers.map((marker, i) => (
                        <div
                            key={i}
                            className="absolute h-full border-l border-neutral-100 flex flex-col items-center"
                            style={{ left: `${marker.left}%` }}
                        >
                            <span className="text-[10px] font-bold text-neutral-300 -translate-y-6">
                                {marker.label}
                            </span>
                        </div>
                    ))}
                ...
                {/* Timeline Bar */}
                <div className="h-20 w-full bg-neutral-50/50 rounded-2xl overflow-hidden relative border border-neutral-100 shadow-inner group/timeline">
                    {/* Current Time Indicator */}
                    {isCurrentTimeVisible && (
                        <div
                            className="absolute top-0 bottom-0 w-0.5 bg-red-500 z-20 pointer-events-none shadow-[0_0_8px_rgba(239,68,68,0.6)]"
                    ...
                    {allocations
                        ...
                        .map((block) => {
                            ...
                            return (
                                <div
                                    key={block.id}
                                    className="absolute top-0 h-full flex flex-col items-center justify-center group cursor-pointer transition-all duration-300 hover:brightness-105 hover:z-10 shadow-[inset_0_1px_rgba(255,255,255,0.2)]"
                                    style={style}
            ...
            {(isAdding || editingBlock) && (
                <div className="fixed inset-0 flex items-center justify-center z-[100] px-4">
                    ...
                    {/* Modal Content */}
                    <div className="bg-white/90 backdrop-blur-2xl rounded-[32px] shadow-2xl border border-white/20 max-w-md w-full overflow-hidden animate-scale-in relative z-10">
                        <div className="p-8">
                            <div className="flex items-center justify-between mb-8">
                                <div>
                                    ...
                                    <p className="text-sm text-neutral-500 font-medium">Design your daily flow</p>
                                </div>
                                <button
                                    onClick={() => { setIsAdding(false); setEditingBlock(null); }}
                            ...
                            <div className="space-y-6">
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        isActive
                                                            ? 'bg-neutral-900 border-neutral-900 shadow-lg shadow-neutral-200 scale-105'
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-black uppercase text-neutral-400 tracking-widest block pl-1">
                                        What&apos;s the focus?
                                    </label>
                                    <input
                                        type="text"
                                        ...
                                        className="w-full px-5 py-4 bg-neutral-50 rounded-2xl border border-neutral-100 focus:outline-none focus:ring-2 focus:ring-neutral-900/5 focus:border-neutral-900 transition-all font-medium text-neutral-900"
                                    />
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            <Clock className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-neutral-400 group-hover:text-neutral-900 transition-colors" />
                                            <input
                                                type="time"
                                                value={formData.startTime}
                                                onChange={(e) => setFormData({ ...formData, startTime: e.target.value })}
                                                className="w-full pl-11 pr-4 py-4 bg-neutral-50 rounded-2xl border border-neutral-100 focus:outline-none focus:ring-2 focus:ring-neutral-900/5 focus:border-neutral-900 transition-all font-bold text-neutral-900"
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <select
                                                ...
                                                className="w-full pl-11 pr-10 py-4 bg-neutral-50 rounded-2xl border border-neutral-100 focus:outline-none focus:ring-2 focus:ring-neutral-900/5 focus:border-neutral-900 transition-all font-bold text-neutral-900 appearance-none"
                                            >
                                ...
                                <div className="flex gap-4 pt-4">
                                    {editingBlock && (
                                        <button
                                            ...
                                            className="p-4 rounded-2xl bg-red-50 text-red-500 hover:bg-red-100 hover:text-red-600 transition-all duration-200"
                                            title="Delete block"
                                        >
                                    ...
                                    <button
                                        ...
                                        className="flex-1 py-4 bg-neutral-900 text-white rounded-2xl font-bold text-lg hover:bg-neutral-800 active:scale-[0.98] transition-all shadow-xl shadow-neutral-200 flex items-center justify-center gap-3"
                                    >
            ...
            {showSettings && (
                <div className="fixed inset-0 flex items-center justify-center z-[100] px-4">
                    ...
                    />
                    <div className="bg-white/90 backdrop-blur-2xl rounded-[32px] shadow-2xl border border-white/20 max-w-sm w-full overflow-hidden animate-scale-in relative z-10 p-8 text-center">
                        <div className="w-16 h-16 bg-neutral-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
                            <Settings className="h-8 w-8 text-neutral-900" />
                        </div>
                        <h3 className="text-2xl font-black text-neutral-900 mb-2">Active Window</h3>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-8">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase text-neutral-400 tracking-widest block text-left pl-1">Starts</label>
                                <input
                                    type="time"
                                    value={dayStart}
                                    onChange={(e) => setDayStart(e.target.value)}
                                    className="w-full px-4 py-4 bg-neutral-50 rounded-2xl border border-neutral-100 focus:outline-none focus:border-neutral-900 transition-all font-bold text-neutral-900 text-center"
                                />
                            </div>
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase text-neutral-400 tracking-widest block text-left pl-1">Ends</label>
                                <input
                                    type="time"
                                    value={dayEnd}
                        ...
                        <div className="flex gap-4">
                            <button onClick={() => setShowSettings(false)} className="flex-1 py-4 font-bold text-neutral-500 hover:text-neutral-900 transition-colors">Dismiss</button>
                            <button onClick={handleSaveSettings} className="flex-1 py-4 bg-neutral-900 text-white rounded-2xl font-bold shadow-lg shadow-neutral-100 hover:bg-neutral-800 transition-all">Save Changes</button>
                        </div>
                    </div>
                </div>
            )}
